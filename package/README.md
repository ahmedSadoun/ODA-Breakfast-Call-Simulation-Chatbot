...
> Generated by `@oracle/bots-node-sdk` on **Tue Dec 20 2022**
...
curl -H "Content-Type: application/json" -d @./spec/test.cc.req.json localhost:3000/components/getAFoodOrderByNumberService

# invoke entity event handler component
curl -H "Content-Type: application/json" -d @./spec/test.eh.req.json localhost:3000/components/resolveentities/getAFoodOrderByNumberService
```
