...
> Generated by `@oracle/bots-node-sdk` on **Fri Dec 23 2022**
...
curl -H "Content-Type: application/json" -d @./spec/test.cc.req.json localhost:3000/components/checkIfNotWentOutService

# invoke entity event handler component
curl -H "Content-Type: application/json" -d @./spec/test.eh.req.json localhost:3000/components/resolveentities/checkIfNotWentOutService
```
