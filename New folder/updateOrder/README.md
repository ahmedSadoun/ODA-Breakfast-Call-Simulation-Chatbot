...
> Generated by `@oracle/bots-node-sdk` on **Sat Dec 24 2022**
...
curl -H "Content-Type: application/json" -d @./spec/test.cc.req.json localhost:3000/components/updateOrderService

# invoke entity event handler component
curl -H "Content-Type: application/json" -d @./spec/test.eh.req.json localhost:3000/components/resolveentities/updateOrderService
```
